...
health_check.verify_cluster
  当 :ref:`健康检查过滤器 <arch_overview_health_checking_filter>` 将远程服务集群写到响应里面时，针对 :ref:`期望的上游服务 <envoy_v3_api_field_config.core.v3.HealthCheck.HttpHealthCheck.service_name_matcher>` 来确定健康检查请求被验证的百分比。
